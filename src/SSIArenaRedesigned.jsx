            ...
            <CardContent className="p-8 md:p-12">
              ...
              <div className="flex items-center gap-4 pt-6 border-t border-amber-200">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-amber-700 mt-1">Founding Director & Chair of Hockey Development for Salt Spring Island Healthy Living Society</p>
                </div>
              </div>
            </CardContent>
          </Card>
